...
## this closes HDF5 file that may be open
...
if platform.system() == 'Windows':
    ...
    fileDirectory = (r'D:/D3/JERC/2014/JERC_L1/JERC_Spectrometer/Reflectance/') # FILE INPUT -- directory of H5 files
...
## NEED THIS FOR JERC -- FILE INPUT -- the plotID formats NEED TO MATCH i.e. no underscores or underscores
xyPlotLoc  = basePath + '/fieldData/JERCPlotCentroids.csv'

# FILE INPUT
# H5 tiles -- this file passes the program which files contain the flightlines that overlap with plots
tiles = open(r'inputs/JERC_bestTiles.csv')
...
### should output a dictionary where: {key = plotID, value1 = flightline_integer, value2 = 'file.h5'}
...
for index, row in dfPlotLoc.iterrows():
    ...
    plotBound[row['plotID']]=[plotCorners,xy]
...
# FIX THIS -- not extracting any data for some reason
###################################
